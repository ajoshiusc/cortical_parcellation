...
view_patch_vtk(dfs_left_sm, azimuth=-90, elevation=-180,
               roll=-90, outfile='dist_sess_orig_view1_1sub_left.png', show=0)
view_patch_vtk(dfs_left_sm, azimuth=90, elevation=180, roll=90,
               outfile='dist_sess_orig_view2_1sub_left.png', show=0)

dfs_left_sm = patch_color_attrib(dfs_left_sm, dist_all_rot, clim=[0.5, 1])
view_patch_vtk(dfs_left_sm, azimuth=-90, elevation=-180, roll=-90,
               outfile='dist_sess_rot_view1_1sub_left.png', show=0)
view_patch_vtk(dfs_left_sm, azimuth=90, elevation=180, roll=90,
               outfile='dist_sess_rot_view2_1sub_left.png', show=0)
