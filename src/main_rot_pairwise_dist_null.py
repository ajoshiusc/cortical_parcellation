...
dfs_left_sm = patch_color_attrib(dfs_left_sm, dist_all_orig, clim=[0, 4])
view_patch_vtk(dfs_left_sm, azimuth=-90, elevation=-180,
               roll=-90, outfile='dist_orig_view1_1sub_left_null.png', show=0)
view_patch_vtk(dfs_left_sm, azimuth=90, elevation=180, roll=90,
               outfile='dist_orig_view2_1sub_left_null.png', show=0)

dfs_left_sm = patch_color_attrib(dfs_left_sm, dist_all_rot, clim=[0, 4])
view_patch_vtk(dfs_left_sm, azimuth=-90, elevation=-180, roll=-90,
               outfile='dist_rot_view1_1sub_left_null.png', show=0)
view_patch_vtk(dfs_left_sm, azimuth=90, elevation=180, roll=90,
               outfile='dist_rot_view2_1sub_left_null.png', show=0)

sp.savez('rot_pairwise_dist_null.npz', dist_all_rot)
sp.savez('rot_pairwise_dist_orig_null.npz', dist_all_orig)
