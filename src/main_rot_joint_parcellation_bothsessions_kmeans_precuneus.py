...
msk_small_region = np.in1d(dfs_left.labels,[(30, 72, 9, 47)])
...
sp.savez_compressed('data_bothsessions_precuneus', cat_data=cat_data, msk_small_region=msk_small_region)
...
sp.savez_compressed('labs_all_data_bothsessions_8_clusters_precuneus', msk_small_region=msk_small_region,lab_sub=lab_sub, cat_data=cat_data, lst=lst, nClusters=nClusters)
