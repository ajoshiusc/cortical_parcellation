        ...
        for j in range(0,2):
            ...
            for sub in lst:
                ...
                if os.path.isfile(os.path.join(p_dir, sub, sub + fadd_1 + str(session_type[j]) + sdir[i] + fadd_2)):
                    ...
                    labs1, correlation_within_precuneus_vector, correlation_with_rest_vector, mask, centroid = parcellate_region((45,22,19,11,20,58,59,66,43), sub, nClusters, sdir[i], scan_type[i],
            ...
            sp.savez(data_file  + str(i*2+j)+'precuneus.npz', correlation_within_precuneus=correlation_within_precuneus,correlation_with_rest=correlation_with_rest, labels=labs_all_1, vertices=labs1.vertices,
