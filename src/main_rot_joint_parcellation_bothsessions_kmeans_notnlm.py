...
for sub in lst:
    data1 = scipy.io.loadmat(os.path.join(p_dir, sub, sub + '.rfMRI_REST1_RL.reduce3.ftdata.hvar_0.mat'))
    data2 = scipy.io.loadmat(os.path.join(p_dir, sub, sub + '.rfMRI_REST2_RL.reduce3.ftdata.hvar_0.mat'))
...
sp.savez_compressed('labs_all_data_bothsessions_17_clusters_notnlm', lab_sub=lab_sub, lst=lst, nClusters=nClusters)
