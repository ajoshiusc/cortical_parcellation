...
def plot_histogram(nsub):
    import matplotlib.pyplot as plt
    # labels=["D-to-S1","D-to-S2","S1-to-S2",""]
    # labels=np.tile(labels,nsub*2)
    import pandas as pd
    Color = ['r', 'g', 'b', 'y', 'k', 'c', 'm', 'w', '#F78F1E', '#BE3224', 'w', 'r', 'g', 'b', 'y', 'k', 'c', 'm', 'w',
             '#F78F1E', '#BE3224', 'w', 'w']
    ...
    SA1 = mpatches.Patch(color='b', label='Session 2 to Session 3')
...
def plot_hist_each_subject(nsub):
    import matplotlib.pyplot as plt
    labels = ["D-to-S1", "D-to-S2", "S1-to-S2", ""]
    labels = np.tile(labels, nsub * 2)
    import pandas as pd
...
def plot_fmri_subject():
    ...
    class sc:
        pass
    for sub in['118528','133928','196750']:
